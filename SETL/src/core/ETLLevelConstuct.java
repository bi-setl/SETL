...
public class ETLLevelConstuct {
	...
	// String demoProvGraph = "C:\\Users\\Amrit\\Documents\\etl\\demo_provGraph.ttl";

	public String updateLevelConstruct(String dimensionalConstruct, String newSourceData, String oldSourceData,
			String sourceTBox, String targetTBox, String targetABox, String prefix, String mapper, String provGraph, String resultFile) {
		...
		return updateTargetABox(targetABox, dimensionalConstruct, prefix, provGraph, correspondingChangedValues, correspondingUpdateType,
				correspondingProvIRIMap, resultFile);
	...
	private String updateTargetABox(String targetABox, String dimensionalConstruct, String prefix,
			String provGraph, LinkedHashMap<String, LinkedHashMap<String, RDFNode>> correspondingChangedValues,
		...
		for (Entry<String, LinkedHashMap<String, RDFNode>> entry : correspondingChangedValues.entrySet()) {
			String prov_subject = correspondingProvIRIMap.get(entry.getKey());
			LinkedHashMap<String, RDFNode> propertiesAndValue = entry.getValue();
